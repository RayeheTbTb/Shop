...
namespace Shop.Specs.PurchaseBills
{
    ...
    public class DeletePurchaseBill : EFDataContextDatabaseFixture
    {
        ...
        [Given("سند خریدی به تاریخ '01 / 01 / 1400' به نام 'فروشنده' برای کالای با عنوان 'شیر کاله' به تعداد '5' با مجموع قیمت '5000 تومان' در تاریخچه فروشگاه وجود دارد")]
        public void Given()
        {
        ...
        [Then("سند خریدی به تاریخ '01 / 01 / 1400' به نام 'فروشنده' برای کالای با عنوان 'شیر کاله' به تعداد '10' با مجموع قیمت '10000 تومان' در تاریخچه فروشگاه نباید وجود داشته باشد")]
        public void Then()
        {
            _dataContext.PurchaseBills.Should().NotContain(_ => _.Id == _billId);
